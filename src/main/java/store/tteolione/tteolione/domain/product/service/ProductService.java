...
public interface ProductService {
    ...
    Slice<ProductDto> getPreviousProductDto(Long categoryId, double longitude, double latitude, LocalDate searchStartDate, LocalDate searchEndDate, Pageable pageable);
