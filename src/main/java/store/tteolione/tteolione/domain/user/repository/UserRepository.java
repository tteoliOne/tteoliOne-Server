...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("select u from User u where u.userId = :userId and u.updateAt <> :updateAt")
    List<User> findByFirstUserId(@Param("userId") Long UserId, @Param("updateAt")LocalDateTime updateAt);
}
